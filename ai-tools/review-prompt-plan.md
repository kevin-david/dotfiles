...
there (`eligible`, `method`, `assessment`, `strengths`, `description_notes`,
`findings`) and no improvised shape. Read that section's rules before you finish.
...
top-level keys and no others: `eligible`, `method`, `assessment`, `strengths`,
...
{
  "eligible": true,
  "method": "How you ACTUALLY reviewed this plan — proof of work, not a restatement of the lenses. Name the specific repo files you opened to verify the plan's claims, which claims you checked (and which held vs. failed), the callers/contracts you traced, and how you checked step ordering and coverage against the plan's stated goal. A generic 'I read the plan and it looks reasonable' is a FAILED section.",
